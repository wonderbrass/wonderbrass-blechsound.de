...
- Bootstraps JS-Bundle (`assets/js/vendor/bootstrap.bundle.min.js`, manuell vendort passend zur Gem-Version) nur für die Collapse-Funktion des mobilen Navigations-Togglers – sonst kein eigenes JavaScript
